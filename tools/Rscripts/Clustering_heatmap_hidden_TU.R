...
# 
my_pg_f <- "H:/data/Synechocystis_6frame/2022-02-02_Hidden_proteome/Hidden_proteome_found_by_TU_sigB.txt"
...
my_target <- my_data[
    my_data$Hidden == TRUE & my_data$`Max/Avg B significant` == "+", ][["id"]]
...
#    paste0(., collapse = "|") %>%
#    paste0("(", ., ")(,|~)")
my_data_format <- my_data_format[my_target, ]
