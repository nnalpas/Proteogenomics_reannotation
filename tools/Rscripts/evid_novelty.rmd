...
#renderPlotly({
    ...
    pl <- plots_box_plotly(
        my_data = evid_match, x = "group", y = "Resolution",
...
#renderPlotly({
    ...
    pl <- plots_box_plotly(
        my_data = evid_match, x = "Database", y = "Resolution",
...
#renderPlotly({
    ...
    pl <- plots_box_plotly(
        my_data = evid_match, x = "group", y = "Mass error [ppm]",
        col_manual = group_colours, txt_size = input$txt_size)
...
#renderPlotly({
    ...
    pl <- plots_box_plotly(
        my_data = evid_match, x = "Database", y = "Mass error [ppm]",
        col_manual = database_colours, txt_size = input$txt_size)
...
#renderPlotly({
    ...
    pl <- plots_box_plotly(
        my_data = evid_match, x = "group", y = "PEP",
        col_manual = group_colours, txt_size = input$txt_size)
...
#renderPlotly({
    ...
    pl <- plots_box_plotly(
        my_data = evid_match, x = "Database", y = "PEP",
        col_manual = database_colours, txt_size = input$txt_size)
...
#renderPlotly({
    ...
    pl <- plots_box_plotly(
        my_data = evid_match, x = "group", y = "Score",
        col_manual = group_colours, txt_size = input$txt_size)
...
#renderPlotly({
    ...
    pl <- plots_box_plotly(
        my_data = evid_match, x = "Database", y = "Score",
        col_manual = database_colours, txt_size = input$txt_size)
