...
```{r psm_group_resolution}

if ("Resolution" %in% colnames(params[["evid_match"]])) {
    
    #renderPlotly({
        
        pl <- plots_box_plotly(
            my_data = params[["evid_match"]], x = "group", y = "Resolution",
...
if ("Resolution" %in% colnames(params[["evid_match"]])) {
    ...
    #renderPlotly({
        ...
        pl <- plots_box_plotly(
            my_data = params[["evid_match"]], x = "Database", y = "Resolution",
...
#renderPlotly({
    ...
    pl <- plots_box_plotly(
        my_data = params[["evid_match"]], x = "group", y = "Mass error [ppm]",
        col_manual = group_colours, txt_size = input$txt_size)
...
#renderPlotly({
    ...
    pl <- plots_box_plotly(
        my_data = params[["evid_match"]], x = "Database", y = "Mass error [ppm]",
        col_manual = database_colours, txt_size = input$txt_size)
...
warning(paste0(
    "There are ",
    sum(params[["evid_match"]][["PEP"]] > 1),
    "PEP values superior to 1 (will be removed)!"))

#renderPlotly({

    pl <- plots_box_plotly(
        my_data = params[["evid_match"]] %>% dplyr::filter(., PEP <= 1),
        x = "group", y = "PEP",
        col_manual = group_colours, txt_size = input$txt_size)
...
#renderPlotly({
    ...
    pl <- plots_box_plotly(
        my_data = params[["evid_match"]], x = "group", y = "Score",
        col_manual = group_colours, txt_size = input$txt_size)
...
#renderPlotly({
    ...
    pl <- plots_box_plotly(
        my_data = params[["evid_match"]], x = "Database", y = "Score",
        col_manual = database_colours, txt_size = input$txt_size)
...
```{r psm_group_intensity}

#renderPlotly({

    pl <- plots_box_plotly(
        my_data = params[["evid_match"]], x = "group", y = "Intensity",
        col_manual = group_colours, txt_size = input$txt_size)
...
#renderPlotly({
    ...
    pl <- plots_box_plotly(
        my_data = params[["evid_match"]], x = "Database", y = "Intensity",
        col_manual = database_colours, txt_size = input$txt_size)
