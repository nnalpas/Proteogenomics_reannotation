...
opt <- list(
    ...
    foreground = "H:/data/Synechocystis_6frame/2022-02-02_Hidden_proteome/Hidden_proteome_for_oa_by_type.txt",
    ...
    maxsize = Inf,
    threads = 1,
    output = "H:/data/Synechocystis_6frame/2022-02-02_Hidden_proteome")
