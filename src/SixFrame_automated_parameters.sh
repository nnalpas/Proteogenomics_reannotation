...
while IFS= read -r line; do
	...
	qsub -d ${HOME}/ws/tu_kxmna01-Proteogenomics-0 -m abe -M nicolas.nalpas@ifiz.uni-tuebingen.de -j eo -V -v SCRIPT_FLAGS="$WKDIR/${array[0]}/Phenodata/$NEWPARAM" -q tiny -l nodes=1:ppn=1,walltime=0:20:00 -N GetOrf ${HOME}/bin/SixFrame_proteogenomics.sh
